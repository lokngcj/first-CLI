 ...
 */
export function findRuleSources(appPath: string): RuleSource[] {
 ...
 */
export function detectStyleSystem(sources: RuleSource[]): string | null {
 ...
 */
export function extractDirectives(sources: RuleSource[]): string[] {
 ...
 */
export function loadRuleSet(appPath: string, appName: string): RuleSet {
