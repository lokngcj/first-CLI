...
export type ExceptionType = 'conflict_marker' | 'guide_mismatch' | 'style_conflict' | 'rule_missing';
...
export type ViolationType = 'direct_axios' | 'direct_fetch' | 'i18n_hardcoding' | 'useCallback_abuse' | 'nonstandard_api_call';
...
export type CommandOutput = PreflightOutput | VerifyOutput | FixSuggestionsOutput | RulesCheckOutput | FigmaCompressOutput;
